...
Договора от 10.10.2014, Протокола от 08.05.2015,
с изм., внесенными Договором от 29.05.2014)
...
(в ред. Договора от 10.10.2014, Протокола от 08.05.2015)
...
(часть вторая введена Протоколом от 16.04.2010)
...
(пп. 41 введен Протоколом от 16.04.2010)
...
(часть вторая в ред. Протокола от 16.04.2010)
...
(часть четвертая введена Протоколом от 16.04.2010)
...
(пп. 3 введен Протоколом от 16.04.2010)
...
(пп. 4 введен Протоколом от 16.04.2010)
...
(часть первая в ред. Протокола от 16.04.2010)
...
5) исключен. - Протокол от 16.04.2010;
...
(пп. 5 введен Протоколом от 16.04.2010)
...
Порядок включения в реестр владельцев таможенных складов и исключения из этого реестра определяется законодательством государств - членов таможенного союза.
...
Статья 51 в части ведения единой Товарной номенклатуры внешнеэкономической деятельности таможенного союза применяется с учетом положений статьи 45 Договора от 29.05.2014.
...
КонсультантПлюс: примечание.
Глава 7 применяется с учетом положений статьи 37 Договора от 29.05.2014.
...
(в ред. Протокола от 16.04.2010)
6. Исключен. - Протокол от 16.04.2010.
...
КонсультантПлюс: примечание.
Часть вторая пункта 2 статьи 77 не применяется (Договор от 29.05.2014).
...
Основания, условия и порядок изменения сроков уплаты налогов определяются законодательством государства - члена таможенного союза, в бюджет которого подлежат уплате налоги.
...
8. Исключен. - Протокол от 16.04.2010.
...
3) исключен. - Протокол от 16.04.2010.
...
2) исключен. - Протокол от 16.04.2010;
...
(пп. 7 введен Протоколом от 16.04.2010)
...
3) проба - товар или часть товара, оптимально необходимая, установленная документацией по стандартизации, характеризующая состав и свойства всего объема представляемого и исследуемого товара;
...
(п. 5 в ред. Протокола от 16.04.2010)
...
(часть пятая в ред. Протокола от 16.04.2010)
...
5. Если после ввоза товаров на таможенную территорию таможенного союза декларантом обнаруживается несоответствие стоимостных, количественных или весовых показателей, отличных от ранее заявленных, декларант вправе отозвать таможенную декларацию в порядке, предусмотренном статьей 192 настоящего Кодекса.
...
2) животные и растения, относящиеся к видам, охраняемым в соответствии с законодательством государств - членов таможенного союза и (или) международными договорами, их частей и дериватов, за исключением случаев, когда требуется их уничтожение в целях пресечения эпидемий и эпизоотий и распространения карантинных объектов;
